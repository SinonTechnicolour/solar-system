...
class PlanetValues(BaseWidget):
    def __init__(self, planet):
        super(PlanetValues,self).__init__('Manipulate Values')
        self.planet = planet
...
class SolarSim(BaseWidget):
    ...
    def __init__(self):
        ...
        self._chooseplanettochange = ControlCombo()
        ...
        self._chooseplanettochange.add_item("Sun",self.sun)
        self._chooseplanettochange.add_item("Mercury",self.mercury)
        self._chooseplanettochange.add_item("Venus",self.venus)
        self._chooseplanettochange.add_item("Earth",self.earth)
        self._chooseplanettochange.add_item("Mars",self.mars)
        self._chooseplanettochange.add_item("Jupiter",self.jupiter)
        self._chooseplanettochange.add_item("Saturn",self.saturn)
        self._chooseplanettochange.add_item("Uranus",self.uranus)
        self._chooseplanettochange.add_item("Neptune",self.neptune)
        ...
        self.formset = [
            ...
            ('_chooseplanettochange','_updatevalues'),
    ...
    sun = resetsun()
    mars = resetmars()
    jupiter = resetjupiter()
    saturn = resetsaturn()
    neptune = resetneptune()
    ...
    def __inputDialogue(self):
        self._chooseplanettochange.value.printbodyattributes()
        win = PlanetValues(self._chooseplanettochange.value)
        win.parent = self
        win.show()
